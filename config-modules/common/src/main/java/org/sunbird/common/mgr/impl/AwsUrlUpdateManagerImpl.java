...
import org.sunbird.common.enums.AwsUrlUpdateErrorCodes;
import org.sunbird.common.enums.CompositeSearchErrorCodes;
import org.sunbird.common.enums.UrlProperties;
...
public class AwsUrlUpdateManagerImpl extends BaseManager implements IAwsUrlUpdateManager {
	...
	private static final String oldPublicBucketName = "sunbird-public";

	/** Old/Existing config AWS Bucket Name. */
	private static final String oldConfigBucketName = "sunbird-config";
