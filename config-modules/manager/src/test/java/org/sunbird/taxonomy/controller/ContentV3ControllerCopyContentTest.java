...
public class ContentV3ControllerCopyContentTest extends CommonTestSetup {
	...
	public static void createDocumentContent() throws Exception {
		for (int i = 1; i <= 2; i++) {
			String createDocumentContent = "{\"osId\":\"org.sunbird.quiz.app\",\"mediaType\":\"content\",\"visibility\":\"Default\",\"description\":\"Unit Test Content\",\"name\":\"Unit Test Content\",\"language\":[\"English\"],\"contentType\":\"Resource\",\"code\":\"testcontent\",\"mimeType\":\"application/pdf\"}";
