...
public class ContentSuggestionTests extends BaseTest {
	...
	String jsonCreateContentRequest = "{\"request\": {\"content\": {\"identifier\": \"LP_NFT_"+rn+"\",\"osId\": \"org.sunbird.quiz.app\", \"mediaType\": \"content\",\"visibility\": \"Default\",\"description\": \"Test_QA\",\"name\": \"LP_NFT_"+rn+"\",\"language\":[\"English\"],\"contentType\": \"Resource\",\"code\": \"Test_QA\",\"mimeType\": \"application/vnd.ekstep.ecml-archive\",\"tags\":[\"LP_functionalTest\"], \"owner\": \"EkStep\"}}}";
	...
	String jsonCreateSuggestionWithoutCommand = "{ \"request\": {\"content\":{\"objectId\":\"nodeId\", \"objectType\":\"content\", \"suggestedBy\":\"rashmi\", \"params\":{\"gradeLevel\":[\"kindergarten\"], \"code\":\"org.sunbird.test\", \"concepts\": [ { \"identifier\": \"LO46\", \"name\": \"Comprehension Of Stories\", \"objectType\": \"Concept\", \"relation\": \"associatedTo\", \"description\": \"Comprehension Of Stories\", \"index\": null } ] } } } } ";
	...
	String jsonCreateSuggestionWithNonExistingObjectId = "{ \"request\": { \"content\": {\"identifier\": \"LP_FT_Test\", \"mediaType\": \"content\", \"visibility\": \"Default\", \"name\": \"testContent\", \"language\": [ \"Hindi\"],\"contentType\": \"Resource\", \"code\": \"org.sunbird.plugin\", \"osId\": \"org.sunbird.quiz.app\", \"pkgVersion\": 1 } } } ";
