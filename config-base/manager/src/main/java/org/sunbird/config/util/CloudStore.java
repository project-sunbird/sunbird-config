...
public class CloudStore {
    ...
    public static Map<String, Object> getConfig() {
        ...
        String cloudStoreContainer = getContainerName();

        if (StringUtils.equalsIgnoreCase(cloudStoreType, "azure")) {
            String cloudStoreAccount = Platform.config.getString("azure_storage_key");
            cloudConfig.put("cloud_store_type", cloudStoreType);
            cloudConfig.put("cloud_store_account", cloudStoreAccount);
            cloudConfig.put("cloud_store_container", cloudStoreContainer);
        } else if (StringUtils.equalsIgnoreCase(cloudStoreType, "aws")) {
            String cloudStoreAccount = Platform.config.getString("aws_storage_key");
            cloudConfig.put("cloud_store_type", cloudStoreType);
            cloudConfig.put("cloud_store_account", cloudStoreAccount);
            cloudConfig.put("cloud_store_container", cloudStoreContainer);
        } else {
